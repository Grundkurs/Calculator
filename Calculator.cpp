...
: mWindow(window){
    ...
    mDisplay.setPosition(sf::Vector2f{35.f, 30.f});
        ...
        if (mSelectedButton) {
            ...
            switch (type) {
                ...
                case (Type::Equal): {
                    ...
                    mComputer.compute();
                    mDisplay.reset();
                    mDisplay.addValue(std::to_string(mComputer.getResult()));
                    break;
                }
                case (Type::AC): {
                    mComputer.reset();
